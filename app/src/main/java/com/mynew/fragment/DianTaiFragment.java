        ...
        Runnable task=new Runnable() {
            ...
            public void run() {
                ...
                if(!NetWorkHelper.isNetWorkAvailable(getContext())){
                    result=cache.getResult("DianTaiFragment"+index);
                }else {
                    result= HttpUrlConnectUtil.getFormWebByHttpUrlConnect(getCommonUrl(Url.DianTaiId,index),null);
                    cache.putResult("DianTaiFragment"+index,result);
                }
                //String result= HttpUrlConnectUtil.getFormWebByHttpUrlConnect(getCommonUrl(Url.DianTaiId,index),null);
                ArrayList<NewModel> arrayList= ReadListJson.getInstance(getContext()).getReadListNewModels(result,Url.DianTaiId);
