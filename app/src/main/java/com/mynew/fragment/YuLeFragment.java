        ...
        Runnable task=new Runnable() {
            ...
            public void run() {
                ...
                if(!NetWorkHelper.isNetWorkAvailable(getContext())){
                    result=cache.getResult("YuLeFragment"+index);
                }else {
                    result= HttpUrlConnectUtil.getFormWebByHttpUrlConnect(getCommonUrl(Url.YuLeId,index),null);
                    cache.putResult("YuLeFragment"+index,result);
                }
                ArrayList<NewModel> arrayList= ReadListJson.getInstance(getContext()).getReadListNewModels(result,Url.YuLeId);
