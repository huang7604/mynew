        ...
        Runnable task=new Runnable() {
            ...
            public void run() {
                ...
                if(!NetWorkHelper.isNetWorkAvailable(getContext())){
                    result=cache.getResult("BoKeFragment"+index);
                }else {
                    result= HttpUrlConnectUtil.getFormWebByHttpUrlConnect(getCommonUrl(Url.BoKeId,index),null);
                    cache.putResult("BoKeFragment"+index,result);
                }
                ArrayList<NewModel> arrayList= ReadListJson.getInstance(getContext()).getReadListNewModels(result,Url.BoKeId);
