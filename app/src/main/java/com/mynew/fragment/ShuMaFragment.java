        ...
        Runnable task=new Runnable() {
            ...
            public void run() {
                ...
                if(!NetWorkHelper.isNetWorkAvailable(getContext())){
                    result=cache.getResult("ShuMaFragment"+index);
                }else {
                    result= HttpUrlConnectUtil.getFormWebByHttpUrlConnect(getCommonUrl(Url.ShuMaId,index),null);
                    cache.putResult("ShuMaFragment"+index,result);
                }
                ArrayList<NewModel> arrayList= ReadListJson.getInstance(getContext()).getReadListNewModels(result,Url.ShuMaId);
