        ...
        Runnable task=new Runnable() {
            ...
            public void run() {
                ...
                if(!NetWorkHelper.isNetWorkAvailable(getContext())){
                    result=cache.getResult("DianYingFragment"+index);
                }else {
                    result= HttpUrlConnectUtil.getFormWebByHttpUrlConnect(getCommonUrl(Url.DianYingId,index),null);
                    cache.putResult("DianYingFragment"+index,result);
                }
                ArrayList<NewModel> arrayList= ReadListJson.getInstance(getContext()).getReadListNewModels(result,Url.DianYingId);
