...
import com.mynew.util.DataTools;
    ...
    public void setOnItemClickListener(final MotionEvent ev) {
        setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view,
                ...
                TextView dragTextView = (TextView)dragViewGroup.findViewById(R.id.grid_text);
                dragTextView.setSelected(true);
                dragTextView.setEnabled(false);
                dragTextView.setTextColor(getContext().getColor(R.color.colorRed));
                dragTextView.setBackgroundResource(R.drawable.text_bg_red);
                ...
                if (dragPosition != AdapterView.INVALID_POSITION) {
                    ...
                    dragTextView.setTextColor(Color.BLACK);
                    dragTextView.setBackgroundResource(R.drawable.text_bg);
                    mVibrator.vibrate(50);//设置震动时间
                    //移动的Item的坐标
                    int[] initLocation=new int[2];
                    dragViewGroup.getLocationInWindow(initLocation);
                    startDrag(dragBitmap, initLocation[0],  initLocation[1]);
                    hideDropItem();
